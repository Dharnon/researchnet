...
$content = [System.IO.File]::ReadAllText((Resolve-Path 'src\app\page.tsx').Path, [System.Text.Encoding]::UTF8)
...
Replace-Section -old $oldEmpty -new $newEmpty -name "empty state"
...
Replace-Section -old $oldConv -new $newConv -name "conversations.map"

# Write back
[System.IO.File]::WriteAllText((Resolve-Path 'src\app\page.tsx').Path, $content, [System.Text.Encoding]::UTF8)
