    ...
    <div style={{ background: t.bg, minHeight: "100vh", padding: 40 }}>
      {[1, 2, 3].map((i) => (
        <div key={i} style={{ display: "flex", gap: 16, marginBottom: 16, alignItems: "center" }}>
          <div style={{ width: 52, height: 52, borderRadius: "50%", background: t.border }} />
          <div style={{ flex: 1 }}>
            <div style={{ width: "40%", height: 14, borderRadius: 4, background: t.border, marginBottom: 6 }} />
            <div style={{ width: "25%", height: 11, borderRadius: 4, background: t.border }} />
          </div>
        </div>
      ))}
    </div>
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "16px 20px", borderBottom: `1px solid ${t.border}` }}>
          ...
          <button onClick={onClose} style={{ background: "none", border: "none", cursor: "pointer", color: t.textTertiary, fontSize: 20, lineHeight: 1, padding: 4 }}>×</button>
        </div>
        <div style={{ flex: 1, overflow: "auto", padding: "24px 20px", display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          <div style={{ background: t.surfaceHover, border: `1px solid ${t.border}`, borderRadius: 12, padding: "12px 16px", display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 11, color: t.textTertiary }}>según áreas y publicaciones</div>
            </div>
          </div>
          <div>
            <p style={{ fontSize: 11, fontWeight: 600, color: t.textSecondary, textTransform: "uppercase", letterSpacing: "0.06em", marginBottom: 6 }}>Biografía</p>
          ...
          <div>
            <p style={{ fontSize: 11, fontWeight: 600, color: t.textSecondary, textTransform: "uppercase", letterSpacing: "0.06em", marginBottom: 8 }}>Áreas</p>
  ...
  return (
    <>
      ...
      <div style={{
        ...
        <p style={{ fontSize: 13, color: t.textSecondary, marginBottom: 16 }}>{opp.dept} · <span style={{ color: "#ea580c", fontWeight: 600 }}>Hasta {opp.deadline}</span></p>
    ...
    <div style={{ maxWidth: 680, margin: "0 auto", padding: "24px" }}>
      ...
      {conversations.length === 0 ? (
        <div style={{ textAlign: "center", padding: "60px 24px", background: t.surface, border: `1px solid ${t.border}`, borderRadius: 12 }}>
          ...
          <p style={{ fontSize: 14, fontWeight: 600, color: t.textPrimary, marginBottom: 4 }}>Sin mensajes aún</p>
          <p style={{ fontSize: 12, color: t.textTertiary }}>Conéctate con investigadores para empezar</p>
        </div>
      ) : (
      ...
      {showOnboarding && (
        <div style={{ position: "fixed", inset: 0, zIndex: 100, background: "rgba(0,0,0,0.55)", backdropFilter: "blur(8px)", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
          <div style={{ background: t.surface, borderRadius: 20, padding: 36, maxWidth: 420, width: "100%", textAlign: "center", boxShadow: t.shadowHover }}>
            ...
            <p style={{ fontSize: 13, color: t.textSecondary, lineHeight: 1.6, marginBottom: 24 }}>Conecta tu perfil ORCID para auto-completar tu información y descubrir investigadores complementarios.</p>
      ...
      {view === "discover" && (
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "40px 24px 60px" }}>
          <div style={{ marginBottom: 28 }}>
            ...
            <p style={{ fontSize: 14, color: t.textSecondary }}>Encuentra colaboradores para tu próximo proyecto</p>
          </div>
          <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap", marginBottom: 20 }}>
            <div style={{ background: t.surface, border: `1px solid ${t.border}`, borderRadius: 8, display: "flex", alignItems: "center", gap: 8, padding: "8px 12px", flex: 1, minWidth: 200 }}>
              ...
              <input value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} placeholder="Buscar por nombre, área o departamento..." style={{ background: "transparent", border: "none", outline: "none", color: t.textPrimary, fontSize: 13, flex: 1 }} />
            </div>
      ...
      {view === "opportunities" && (
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "40px 24px 60px" }}>
          <div style={{ marginBottom: 28 }}>
            ...
            <p style={{ fontSize: 14, color: t.textSecondary }}>Postdocs, becas, convocatorias y más</p>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: 16 }}>
              ...
              return (
                ...
                >
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    ...
                    {opp.hot && <span style={{ fontSize: 10, fontWeight: 700, color: "#ea580c" }}>🔥</span>}
                  </div>
                  ...
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: 4 }}>
                    ...
                    <span style={{ fontSize: 12, fontWeight: 600, color: t.accent, display: "flex", alignItems: "center", gap: 3 }}>Ver más <ChevronRight size={12} /></span>
                  </div>
                </div>
              );
            })}
      ...
      {view === "profile" && (
        <div style={{ maxWidth: 800, margin: "0 auto", padding: "40px 24px 60px" }}>
          ...
          <div style={{ background: t.surface, border: `1px solid ${t.border}`, borderRadius: 16, padding: 28, marginBottom: 16, boxShadow: t.shadowCard }}>
            ...
            <div>
              <p style={{ fontSize: 11, fontWeight: 600, color: t.textSecondary, textTransform: "uppercase", letterSpacing: "0.06em", marginBottom: 8 }}>Grupos de investigación</p>
              <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
