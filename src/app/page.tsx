  ...
  return (
    <div style={{ background: "var(--bg)", minHeight: "100vh", padding: "24px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(300px, 1fr))", gap: 16 }}>
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div key={i} className="skeleton-card" style={{ background: "var(--card-bg)", border: "1px solid var(--border)", borderRadius: 14, padding: 18, display: "flex", flexDirection: "column", gap: 12, animationDelay: `${i * 80}ms` }}>
      ...
      <div style={{
        ...
        <div style={{ flex: 1, overflow: "auto", padding: "18px", display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <div style={{ display: "flex", gap: 14, alignItems: "flex-start" }}>
            ...
            <div style={{ flex: 1 }}>
              <h2 style={{ fontSize: 17, fontWeight: 700, color: "var(--text-primary)", letterSpacing: "-0.02em", lineHeight: 1.25, marginBottom: 4, fontFamily: "'Playfair Display', serif" }}>{researcher.name}</h2>
          ...
          {/* Match score — restrained editorial pill, not oversized */}
          <div style={{
            display: "inline-flex",
            alignItems: "center",
            gap: 6,
            ...
            <span style={{ fontSize: 13, fontWeight: 800, color: researcher.match >= 90 ? "var(--match-high)" : researcher.match >= 70 ? "var(--match-mid)" : "var(--match-low)", letterSpacing: "-0.04em", lineHeight: 1 }}>{researcher.match}</span>
        ...
        <div style={{ padding: "14px 20px 18px", borderTop: "1px solid var(--card-border)" }}>
          <button
            ...
            style={{
              ...
              color: isConnected ? "var(--connected-color)" : "#FFFFFF",
              display: "flex",
              alignItems: "center",
              ...
              boxShadow: isConnected ? "none" : "0 2px 12px var(--accent-glow)",
            }}
          >
            {isConnected
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "flex-start", gap: 14, position: "relative" }}>
        ...
        <div style={{
          ...
          display: "flex", alignItems: "center", justifyContent: "center",
          fontSize: 13, fontWeight: 700, color: researcher.color,
          flexShrink: 0, letterSpacing: "-0.03em",
          transition: "box-shadow 0.22s ease, transform 0.22s ease",
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 6, marginBottom: 4 }}>
            <span style={{ fontSize: 14, fontFamily: "'Playfair Display', Georgia, serif", fontWeight: 700, color: "var(--text-primary)", lineHeight: 1.3, letterSpacing: "-0.01em" }}>{researcher.name}</span>
  ...
  return (
    <div style={{ maxWidth: 700, margin: "0 auto", padding: "24px" }}>
      <div style={{ marginBottom: 24 }}>
        <h1 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontStyle: "italic", fontSize: 26, fontWeight: 700, color: "var(--text-primary)", letterSpacing: "-0.03em", lineHeight: 1.2, marginBottom: 5 }}>Mensajes</h1>
    ...
    <div style={{ background: "var(--bg)", minHeight: "100vh", color: "var(--text-primary)" }}>
      ...
      {view === "discover" && (
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "24px" }}>
          <div style={{ marginBottom: 24 }}>
            <h1 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontStyle: "italic", fontSize: 26, fontWeight: 700, color: "var(--text-primary)", letterSpacing: "-0.03em", lineHeight: 1.2, marginBottom: 5 }}>Descubrir investigadores</h1>
      ...
      {view === "opportunities" && (
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "24px" }}>
          <div style={{ marginBottom: 24 }}>
            <h1 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontStyle: "italic", fontSize: 26, fontWeight: 700, color: "var(--text-primary)", letterSpacing: "-0.03em", lineHeight: 1.2, marginBottom: 5 }}>Oportunidades</h1>
            ...
            <div style={{ display: "flex", alignItems: "flex-start", gap: 20, marginBottom: 24 }}>
              ...
              <div style={{ flex: 1 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 4, flexWrap: "wrap" as const }}>
                  <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontStyle: "italic", fontSize: 22, fontWeight: 700, color: "var(--text-primary)", letterSpacing: "-0.02em", lineHeight: 1.25, marginBottom: 2 }}>{userProfile.name} {userProfile.surname}</h2>
                  {userProfile.open && (
