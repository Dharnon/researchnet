...
// --- MATCH BADGE (slate-blue: green =90, amber =70, gray <70) ---------------------
      ...
      <div style={{
        ...
        <div style={{ flex: 1, overflow: "auto", padding: "18px", display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <div style={{ display: "flex", gap: 14, alignItems: "flex-start" }}>
            ...
            <div>
              <h2 style={{ fontSize: 18, fontWeight: 700, color: "var(--text-primary)", letterSpacing: "-0.02em", marginBottom: 2 }}>{researcher.name}</h2>
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", padding: "24px" }}>
          ...
          {connectedResearchers.length === 0 ? (
            <div className="empty-state" style={{ position: "relative", overflow: "hidden" }}>
              <div style={{ position: "absolute", inset: 0, background: "radial-gradient(ellipse at 50% 40%, rgba(91,143,212,0.08) 0%, transparent 70%)", pointerEvents: "none" }} />
              <svg width="64" height="64" viewBox="0 0 64 64" fill="none" style={{ display: "block" }}>
                ...
                <circle cx="32" cy="32" r="3" fill="#5b8fd4" opacity="0.8"/>
                {/* Satellite nodes */}
                ...
                {/* Connection lines */}
                <line x1="24" y1="27" x2="18" y2="21" stroke="#5b8fd4" strokeWidth="1" strokeDasharray="3 2" opacity="0.4"/>
                <line x1="40" y1="27" x2="46" y2="21" stroke="#5b8fd4" strokeWidth="1" strokeDasharray="3 2" opacity="0.4"/>
                <line x1="24" y1="37" x2="18" y2="43" stroke="#5b8fd4" strokeWidth="1" strokeDasharray="3 2" opacity="0.4"/>
                <line x1="40" y1="37" x2="46" y2="43" stroke="#5b8fd4" strokeWidth="1" strokeDasharray="3 2" opacity="0.4"/>
                ...
                {/* Satellite node dots */}
                <circle cx="14" cy="18" r="2" fill="#5b8fd4" opacity="0.45"/>
                <circle cx="50" cy="18" r="2" fill="#5b8fd4" opacity="0.45"/>
                <circle cx="14" cy="46" r="2" fill="#5b8fd4" opacity="0.45"/>
                <circle cx="50" cy="46" r="2" fill="#5b8fd4" opacity="0.45"/>
              </svg>
            ...
            <div style={{ display: "flex", alignItems: "flex-start", gap: 20, marginBottom: 24 }}>
              ...
              <div style={{ flex: 1 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 4, flexWrap: "wrap" as const }}>
                  <h2 style={{ fontSize: 20, fontWeight: 700, color: "var(--text-primary)", letterSpacing: "-0.03em" }}>{userProfile.name} {userProfile.surname}</h2>
                  {userProfile.open && (
