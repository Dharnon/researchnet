    ...
    <div style={{ background: "var(--bg)", minHeight: "100vh", color: "var(--text-primary)", fontFamily: "inherit" }}>
      ...
      {view === "discover" && (
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "24px" }}>
          <div style={{ marginBottom: 24 }}>
            <div style={{ marginBottom: 24 }}><h1 className="vc-section-heading">Descubrir investigadores</h1></div>
      ...
      {view === "profile" && (
        <div style={{ maxWidth: 800, margin: "0 auto", padding: "24px" }}>
          <div style={{ marginBottom: 24 }}>
            <h1 className="vc-section-heading" style={{ fontStyle: "italic", fontSize: 26, fontWeight: 600, letterSpacing: "-0.03em", lineHeight: 1.2, marginBottom: 5 }}>Tu perfil</h1>
