  ...
  return (
    <div
      ...
      style={{
        ...
        border: `1.5px solid ${hovered ? color + "a0" : color + "35"}`,
        boxShadow: hovered
          ? `0 0 0 1px rgba(255,255,255,0.05), 0 2px 8px rgba(0,0,0,0.4), 0 0 14px ${color}25, inset 0 1px 0 rgba(255,255,255,0.06)`
          : `0 0 0 1px rgba(255,255,255,0.04), 0 1px 3px rgba(0,0,0,0.25), inset 0 1px 0 rgba(255,255,255,0.04)`,
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ flex: 1, overflow: "auto", padding: "18px", display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          {/* Match score — subtle horizontal pill */}
          <div style={{
            display: "inline-flex",
            alignItems: "center",
            gap: 6,
            ...
            <span style={{
              ...
              color: researcher.match >= 90 ? "var(--match-high)" : researcher.match >= 70 ? "var(--match-mid)" : "var(--match-low)",
              letterSpacing: "-0.04em", lineHeight: 1,
            }}>{researcher.match}</span>
            <span style={{
              fontSize: 10, fontWeight: 500,
              color: researcher.match >= 90 ? "var(--match-high)" : researcher.match >= 70 ? "var(--match-mid)" : "var(--match-low)",
              opacity: 0.50, letterSpacing: "0.04em",
            }}>%</span>
          </div>
